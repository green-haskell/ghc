...
int rapl_get_cpu_id(void);
int rapl_get_cpu_model(void);
char rapl_available(void);
...
char rapl_pkg_available(void);
char rapl_pp0_available(void);
char rapl_pp1_available(void);
char rapl_dram_available(void);
char rapl_uncore_available(void);
